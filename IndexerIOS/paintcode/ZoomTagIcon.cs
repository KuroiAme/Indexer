...
namespace IndexerIOS
{
	public static class ZoomTagIcon
	{
		...
		static void paintCodeRetina ()
		{
			...
			//// Rectangle Drawing
			var rectangleRect = new RectangleF(4.5f, 2.5f, 35, 39);
			...
			new NSString("ZOOM TAG").DrawString(RectangleF.Inflate(rectangleRect, 0, -7), UIFont.FromName("Helvetica", 11), UILineBreakMode.WordWrap, UITextAlignment.Center);
